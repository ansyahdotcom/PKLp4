...
<div class="logo-helper"><a href='http://trustyplugins.com' target="_blank">
 <?php
  if(class_exists("TC_CAF_PRO")) {
   ?>
 ...
 <?php
  ...
  ?>
	...
	<div class="manage-top-dash general-tab new-tab"><span class="dashicons dashicons-admin-tools"></span><span class='text'>
		<?php echo esc_html('General Settings','tc_caf'); ?></span> <a href='<?php echo esc_url('http://trustyplugins.com','tc_caf'); ?>' target="_blank"><i class="fa fa-info-circle" aria-hidden="true"></i><?php echo esc_html('Documentation','tc_caf'); ?> </a></div></div>
   ...
   <li class="nav-item" role="presentation">
		<a class="nav-link" id="layouts-tab" data-toggle="tab" href="#layoutstab" role="tab" aria-controls="layouts-tab" aria-selected="false"><?php echo esc_html('Layouts','tc_caf');?> <br/><span class="info-bt"><?php echo esc_html('Post Layout, Filter Layout','tc_caf'); ?></span><span class="dashicons dashicons-visibility"></span></a>
	  </li>
	  <li class="nav-item" role="presentation">
